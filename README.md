...
- `tkinter_gui.py`: Provides the graphical user interface for the game using Tkinter.
- `db_setup.py`: Initializes the SQLite database with base items, goal milestones, and guide elements from a CSV file.
